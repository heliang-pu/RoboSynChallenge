# handle_basket / coverage_strat_milk00_basket01

- 用途: 全范围分层补匀(kind=strat)
- 建议集数: 32
- 事件模式: keep-original(仅收窄官方事件范围)
- 依据: stratified block over the official random range (no pose columns in the dataset): basket_x[0.600,0.650] basket_y[-0.125,-0.100] milk_x[0.600,0.675] milk_y[0.050,0.175]
...
输出数据集: `lerobot_dataset/coverage/handle_basket/coverage_strat_milk00_basket01`
