# items_handover / coverage_gap_pen_y_hi

- 用途: 密度缺口补采(kind=marginal)
- 建议集数: 80
- 事件模式: pair-constrained(约束对采样)
- 依据: pen_y in [-0.037, 0.000] holds 57 kept episodes vs 122.9 expected (8-bin uniform)
- 几何依据: half_extents pen=[0.07561, 0.00805, 0.00805], holder=[0.0485, 0.10131, 0.0485](mesh AABB x body_scale x 1.05), min_xy_clearance=0.03, max_xy_center_distance=0.36(非约束上界)
- 离线 MC 可行率(2 万采样): 69.8%

## 区间(config 单位,与官方 random 对比)

| 对象 | 参数 | 官方 random | 本配置 |
|---|---|---|---|
| pen | position_range | [[0.52, -0.3, 0.884], [0.675, 0.0, 0.884]] | [[0.52, -0.0375, 0.884], [0.675, 0.0, 0.884]] |
...
输出数据集: `lerobot_dataset/coverage/items_handover/coverage_gap_pen_y_hi`
