...
results_root="${SMOLVLA_RESULTS_ROOT:-/mnt/FermiBotNas/models/RoboSynChallenge/official_smolvla_drawer_open_place_eval/c0088d84a568f93fb4401aabafcc41cf643efcdd}"
