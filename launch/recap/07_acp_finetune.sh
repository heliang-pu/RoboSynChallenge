...
#       保存间隔:SIMRECAP_SAVE_INTERVAL=2500。兼容旧写法 SIMRECAP_INDICATOR_KEY=none。
...
log "已脱离会话启动 pid=$pid  日志:$LAUNCH/train.log  ACP=$SIMRECAP_ACP_ENABLE dropout=$SIMRECAP_ACP_DROPOUT indicator=$SIMRECAP_INDICATOR_KEY save=$SIMRECAP_SAVE_INTERVAL"
