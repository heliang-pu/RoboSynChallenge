...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        #   SIMRECAP_BATCH_SIZE / SIMRECAP_FSDP_DEVICES / SIMRECAP_NUM_WORKERS
        #   SIMRECAP_NUM_TRAIN_STEPS
        #                          训练资源与步数,默认 64/1/2/20000
        ...
        num_workers=_env_positive_int("SIMRECAP_NUM_WORKERS", 2),
